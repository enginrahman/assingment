    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?php echo base_url('/item/store') ?>" method="post" enctype="multipart/form-data">
              ...
              <select class="form-control" name="brandName" required id="brandId" aria-label="Default select example">         
              ...
              <select name="modelName" class="form-control" id="ModelId" required aria-label="Default select example">          
                <option selected>Select Model</option>
              </select>  
              <label for="">Item Name</label>
              <input type="text" required class="form-control" name='itemname' placeholder="type your item name">
              <button type="button" class="btn btn-secondary m-2" style="float:right;" data-dismiss="modal">Close</button>
