                            ...
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                  <form action="<?php echo base_url('/new/model') ?>" method="post" enctype="multipart/form-data">
                                      ...
                                      <select class="form-control" required name="brandName" id="brandId" aria-label="Default select example">         
                                      ...
                                      <input type="text" required class="form-control" name='ModelName' placeholder="type your Model Name"> 
                                ...
                                <label for=""> Brand </label> 
                                  <select class="form-control" required name="brandName" id="brandId" aria-label="Default select example">                       
                                      ...
                                      <label for="inputPassword">Brand Name <span class="text-danger">*</span></label>
                                        ...
                                        <input type="text" required class="form-control"  name='ModelName' id="inputPassword"  value="<?php echo $Mdata['name'] ?>">
                        ...
                        <div class="modal fade" id="DeleteModal<?php echo $Mdata['model_id']?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                <form action="<?php echo base_url('/item/delete/')?>" method="get">
                                  <input type="hidden" name="id" value="<?php echo $Mdata['model_id'] ?>">
